...
class PDFComparerApp:
    ...
    def create_compare_buttons(self):
        ...
        self.create_compare_button(compare_frame, "Rationalise (Excel)", self.compare_pdfs_excel)
        ...
        self.create_compare_button(compare_frame, "Percentage Match (Excel)", self.compare_similarity_excel,
                                   padx=(15, 0))
        self.create_compare_button(compare_frame, "Percentage Match (CSV)", self.compare_similarity_csv, padx=(15, 0))
        self.create_compare_button(compare_frame, "Percentage Match (HTML)", self.compare_similarity_html, padx=(15, 0))
    ...
    def create_compare_button(self, frame, text, command, padx=None):
        button = self.create_button(frame, text, lambda: threading.Thread(target=command).start(),
                                    font=("Helvetica", 10, "bold"), width=20, height=2, bg="white")

...
class PDFComparerApp:
    ...
    def extract_paragraphs_from_pdf(self, file_path):
        # open the individual pdf file and get all the paragraphs
        paragraphs = []
        try:
            ...
            # Only remove the empty string if it is in the list
            if "" in paragraphs:
                paragraphs.remove("")
    ...
    def compare_pdfs(self):
        ...
        # Add your PDF comparison code here using the input_folder and output_folder paths
    ...
    def compare_similarity(self):
        ...
        for row in range(len(matrix)):
            final_row = []
            final_row.append(para[row + 1])
            final_row += matrix[row]
